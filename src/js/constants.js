...
export const FALLBACK_SVG_SPRITE =
...
export const COMPONENT_INDEX_TYPES = [
  'external',
  'stages',
  'rows',
  'columns',
...
export const COMPONENT_TYPE_CLASSNAMES_LOOKUP = Object.entries(
...
export const COMPONENT_TYPE_CLASSNAMES_ARRAY = Object.values(
  COMPONENT_TYPE_CLASSNAMES
);
export const COMPONENT_TYPE_CLASSNAMES_REGEXP = new RegExp(
  `${COMPONENT_TYPE_CLASSNAMES_ARRAY.join('|')}`,
  'g'
);
...
export const CHANGE_TYPES = [
  { type: 'added', condition: (o, n) => Boolean(o === undefined && n) },
];
